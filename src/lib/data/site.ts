...
export const site = {
  ...
  description:
    "Online coaching with Dean Foster. Meals and workouts built around your goals, simple to log, with weekly check-ins so you are never figuring it out alone.",
