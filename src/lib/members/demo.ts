...
export const demoMeals: Meal[] = [
  ...
  },
  {
    ...
    fatG: 12,
    ingredients: [
      { id: "in-8", position: 0, name: "Chicken breast", quantity: 150, unit: "g" },
      { id: "in-9", position: 1, name: "Basmati rice", quantity: 75, unit: "g" },
      { id: "in-10", position: 2, name: "Tenderstem broccoli", quantity: 100, unit: "g" },
      { id: "in-11", position: 3, name: "Olive oil", quantity: 10, unit: "ml" },
      { id: "in-12", position: 4, name: "Soy sauce", quantity: 15, unit: "ml" },
    ],
    method: [
      "Get the rice on — it takes the longest.",
      "Slice the chicken and fry it in the oil until it is golden and cooked through.",
  ...
  },
  {
    ...
    fatG: 18,
    ingredients: [
      { id: "in-17", position: 0, name: "Cod fillet", quantity: 180, unit: "g" },
  ...
  },
  {
    ...
    fatG: 3,
    ingredients: [
      { id: "in-28", position: 0, name: "Whey protein", quantity: 30, unit: "g" },
      { id: "in-29", position: 1, name: "Water", quantity: 300, unit: "ml" },
    ],
    method: [],
    archivedAt: null,
  },
  {
    ...
    fatG: 5,
    ingredients: [
      { id: "in-30", position: 0, name: "Greek yoghurt", quantity: 170, unit: "g" },
      { id: "in-31", position: 1, name: "Mixed berries", quantity: 80, unit: "g" },
      { id: "in-32", position: 2, name: "Honey", quantity: 10, unit: "g" },
    ],
