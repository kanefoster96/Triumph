 ...
 *
 * `showWordmark` defaults on: most places the logo appears need the name
 * spelled out. The header drops it — the mark alone reads fine at that size,
 * and the display font it would otherwise borrow isn't the right one.
 */
